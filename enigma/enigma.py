...
for line in f:
    (combo, num1, num2, num3) = line.split(',')
    letter1 = combo[0]
    letter2 = combo[1]
    letter3 = combo[2]
    num1 = int(num1)
    num2 = int(num2)
    num3 = int(num3)
    x = Machine("BF CM DR GQ JK LU OY PW ST", Rotor("I", letter1, int(num1)), Rotor("II", letter2, int(num2)), Rotor("III", letter3, int(num3))).\
        transcode("GCXS SBPP IUDN WXJZ GIIC UEFY GISXQ OCGL LGMM KYHJ")
    print x.replace(" ","")+'\n'
    x = Machine("BF CM DR GQ JK LU OY PW ST", Rotor("I", letter1, int(num1)), Rotor("III", letter2, int(num2)), Rotor("II", letter3, int(num3))).\
        transcode("GCXS SBPP IUDN WXJZ GIIC UEFY GISXQ OCGL LGMM KYHJ")
    print x.replace(" ","")+'\n'
    x = Machine("BF CM DR GQ JK LU OY PW ST", Rotor("II", letter1, int(num1)), Rotor("I", letter2, int(num2)), Rotor("III", letter3, int(num3))).\
            transcode("GCXS SBPP IUDN WXJZ GIIC UEFY GISXQ OCGL LGMM KYHJ")
    print x.replace(" ","")+'\n'
    x = Machine("BF CM DR GQ JK LU OY PW ST", Rotor("II", letter1, int(num1)), Rotor("III", letter2, int(num2)), Rotor("I", letter3, int(num3))).\
        transcode("GCXS SBPP IUDN WXJZ GIIC UEFY GISXQ OCGL LGMM KYHJ")
    print x.replace(" ","")+'\n'
    x = Machine("BF CM DR GQ JK LU OY PW ST", Rotor("III", letter1, int(num1)), Rotor("I", letter2, int(num2)), Rotor("II", letter3, int(num3))).\
        transcode("GCXS SBPP IUDN WXJZ GIIC UEFY GISXQ OCGL LGMM KYHJ")
    print x.replace(" ","")+'\n'
    x = Machine("BF CM DR GQ JK LU OY PW ST", Rotor("III", letter1, int(num1)), Rotor("II", letter2, int(num2)), Rotor("I", letter3, int(num3))).\
        transcode("GCXS SBPP IUDN WXJZ GIIC UEFY GISXQ OCGL LGMM KYHJ")
    print x.replace(" ","")+'\n'
